...
# SOLUTION:- THINKKING ABOUT THE SOLUTION TO MAKE MULTIPLE TRANSITION AND I HAVE TO ADD "TRY AND EXPECT" TO GET DATA IN INT OR FLOAT
print("""CREATED BY:- KUMAR ABHISHEK
        LAST EDITED ON :- 28 JAN. 2021""")
